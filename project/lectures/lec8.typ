...
Example : Hospital waiting list. In case of emergency removal is from
rear instead of front.
...
- A node is an ancestor of another node if it lies on the path from it
  to the root node
...
It is not necessary for a complete binary tree to be full. e.g 1 - (2 -
(4) 3) is not a full binary tree but it is a complete binary tree
...
In a complete binary tree the depths of all leaf nodes differ by at most
1.
...
- Edge: Connection between two nodes. Number of edges = Number of nodes
  \- 1
