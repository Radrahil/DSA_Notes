...
- [Sort 4 elements using 4 comparisons](#sort-4-elements-using-4-comparisons)
- [Stacks](#stacks)
  * [Basic Stack Operations](#basic-stack-operations)
- [Checking For Balanced Parentheses](#checking-for-balanced-parentheses)
  * [Rules For Balanced Parentheses](#rules-for-balanced-parentheses)
  * [Algorithm](#algorithm)
...
Four elements: ```a b c d``` -> 4! = 24 possible combinations for final order
The optimal comparison will split the possibilities into 2
...
> [!IMPORTANT]
> Every comparison-based sorting algorithm makes at least (1/4) n log₂(n) comparisons
> in the worst case
...
- At every step while scanning the expression from left to right, the number
of open parentheses >= closed parentheses.
...
If you ever try to pop an empty stack or if the stack isn't empty at the end,
