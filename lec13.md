...
- [Lecture 13](#lecture-13)
  - [Heaps](#heaps)
    - [Left-justified (or Complete) binary tree](#left-justified-or-complete-binary-tree)
    - [Insertion into Heap](#insertion-into-heap)
    - [Deletion from Heap](#deletion-from-heap)
    - [Heap as an Array](#heap-as-an-array)
<!--toc:end-->
...
We insert into the appropriate position at bottom,
such that it maintains left-justified property.

Then, if inserted < parent, swap them.
Repeat until node < parent or parent = NULL
...
Thus, as construction from a random array is O(nlog₂(n)),
sorting the array is a viable way to start.
