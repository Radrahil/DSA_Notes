...
Thus, for all permutations where 6 appears before 7, 6 is an ancestor of 7 ($X_(6 , 7) = 1$) and vice versa.

Thus, $P r [X_(7 , 6) = 1]$ = $1 / 2$ because for all permutations where 6 is before 7, there exists a permutation where the 6 and 7 are swapped and 7 comes before 6
